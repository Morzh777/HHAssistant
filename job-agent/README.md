...
**HH Assistant** - это интеллектуальный помощник для поиска работы на HeadHunter с автоматической генерацией сопроводительных писем на основе AI. Система состоит из Chrome расширения и NestJS backend с поддержкой множественных AI провайдеров.

### 🎯 Что делает программа

**HH Assistant** автоматизирует процесс поиска работы и откликов на вакансии:

- **🔍 Умный поиск вакансий** - универсальный поиск с поддержкой всех параметров HeadHunter API
...
- [x] **Временные фильтры** для поиска по датам
...
- [ ] **Автоматические рекомендации** на основе анализа профиля
- [ ] **Мониторинг новых вакансий** с уведомлениями
- [ ] **Расширенная аналитика** поиска работы
